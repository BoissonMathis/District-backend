...
describe("addManyPosts", () => {
    it("Posts à ajouter, valide. - S", (done) => {
        var posts_tab = [{
            ...
            user: rdm_user(tab_id_users),
            contentText: 'troisieme post test'
        },{
            user: rdm_user(tab_id_users),
            contentText: 'Quatrieme post test'
        }]
...
describe("findManyPosts", () => {
    ...
    //     PostService.findManyPosts('Ceci', 3, 1, null, function (err, value) {
    //         console.log(value)
    //         done()
    //     })
    // })
    it("Faire une recherche avec une query vide - S", (done) => {
        PostService.findManyPosts(null, 3, 1, null, function (err, value) {
    ...
    it("Faire une recherche avec une query qui ne correspond a aucun post - S", (done) => {
        PostService.findManyPosts('awtbrieoqpmfnhgsekl', 3, 1, null, function (err, value) {
            expect(value).to.haveOwnProperty("count")
            expect(value).to.haveOwnProperty("results")
