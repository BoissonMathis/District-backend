...
describe("addOneEvent", () => {
  ...
  it("Evenement incorrect. (sans user) - E", (done) => {
    ...
    EventService.addOneEvent(event_without_user, null, function (err, value) {
      ...
      expect(err["msg"]).to.equal("Path `user` is required.");
      done();
    });
  });
  it("Evenement incorrect. (sans contentText) - E", (done) => {
    ...
    EventService.addOneEvent(
      event_without_contentText,
      null,
      function (err, value) {
        expect(err).to.be.a("object");
        expect(err).to.haveOwnProperty("msg");
        ...
        expect(err).to.haveOwnProperty("type_error");
        expect(err["msg"]).to.equal("Path `contentText` is required.");
        done();
      }
    );
  });
...
describe("findOneEventById", () => {
  ...
  it("Chercher un evenement inexistant avec un id introuvale. - E", (done) => {
    EventService.findOneEventById(
      "66c6e6beb82890309a6e3dae",
      null,
      function (err, value) {
        expect(err).to.be.a("object");
        expect(err).to.haveOwnProperty("msg");
        expect(err["msg"]).to.equal("Aucun événement trouvé.");
        expect(err).to.haveOwnProperty("type_error");
...
describe("findManyEventsById", () => {
  ...
  it("Chercher des evenements inexistant avec id correct. - E", (done) => {
    EventService.findManyEventsById(
      ["66a2bfe9c6586ef77eef101d", "66a2bfe9c6586ef77eef101c"],
      null,
      function (err, value) {
        expect(err).to.be.a("object");
        expect(err).to.haveOwnProperty("msg");
    ...
    EventService.findManyEventsById(
      ...
      function (err, value) {
        ...
        expect(err["msg"]).to.equal(
          "Tableau non conforme plusieurs éléments ne sont pas des ObjectId."
        );
        expect(err).to.haveOwnProperty("type_error");
        expect(err["type_error"]).to.equal("no-valid");
        expect(err).to.haveOwnProperty("fields");
...
describe("findOneEvent", () => {
  ...
  it("Chercher un evenement par un champ non autorisé. - E", (done) => {
    EventService.findOneEvent(
      ...
      function (err, value) {
        ...
        expect(err).to.haveOwnProperty("msg");
        expect(err["msg"]).to.equal(
          "Les champs (test) ne sont pas des champs de recherche autorisés."
        );
        expect(err).to.haveOwnProperty("type_error");
        expect(err["type_error"]).to.equal("no-valid");
  ...
  it("Chercher un evenement sans champ de recherche. - E", (done) => {
    EventService.findOneEvent([], events[0].level, null, function (err, value) {
      expect(err).to.be.a("object");
      expect(err).to.haveOwnProperty("msg");
      expect(err["msg"]).to.equal("Erreur interne MongoDB");
      expect(err).to.haveOwnProperty("type_error");
...
describe("findManyEvents", () => {
  it("Faire une recherche valide - S", (done) => {
    EventService.findManyEvents("U8 - U9", 3, 1, null, function (err, value) {
  ...
  it("Faire une recherche avec une query vide - S", (done) => {
    EventService.findManyEvents(null, 3, 1, null, function (err, value) {
      expect(value).to.haveOwnProperty("count");
      expect(value).to.haveOwnProperty("results");
  ...
  it("Faire une recherche avec une query qui ne correspond a aucun evenement - S", (done) => {
    EventService.findManyEvents("U18", 3, 1, null, function (err, value) {
      //   expect(value).to.haveOwnProperty("count");
      //   expect(value).to.haveOwnProperty("results");
...
describe("updateOneEvent", () => {
  it("Modifier un evenement correct. - S", (done) => {
    EventService.updateOneEvent(
      id_event_valid,
      { contentText: "Ceci est un update" },
      null,
      function (err, value) {
        expect(value).to.be.a("object");
        expect(value).to.haveOwnProperty("_id");
...
describe("updateManyEvents", () => {
  it("Modifier plusieurs evenements correctement. - S", (done) => {
    EventService.updateManyEvents(
      tab_id_events,
      { contentText: "Ceci est un update many" },
      null,
      function (err, value) {
  ...
  it("Modifier plusieurs evenements avec id incorrect. - E", (done) => {
    EventService.updateManyEvents(
      ["177852", "7412863"],
      { contentText: "Ceci est un autre update many" },
      null,
      function (err, value) {
        expect(err).to.be.a("object");
        expect(err).to.haveOwnProperty("msg");
        expect(err["msg"]).to.equal("Id's invalide.");
        expect(err).to.haveOwnProperty("type_error");
        expect(err["type_error"]).to.equal("no-valid");
        done();
      }
  ...
  it("Modifier plusieurs evenements avec id introuvable. - E", (done) => {
    EventService.updateManyEvents(
      ["66a2bfe9c6586ef77eef101c", "66a2bfe9c6586ef77eef101d"],
      { contentText: "Ceci est un autre update many" },
      null,
      function (err, value) {
        expect(err).to.be.a("object");
