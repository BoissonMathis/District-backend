...
describe("GET - /comment/:id", () => {
  ...
  it("Chercher un commentaire incorrect (avec un id inexistant). - E", (done) => {
    chai
      .request(server)
      .get("/comment/665f18739d3e172be5daf092")
      .auth(valid_token, { type: "bearer" })
      .end((err, res) => {
...
describe("PUT - /comment", () => {
  ...
  it("Modifier un commentaire avec un id inexistant. - E", (done) => {
    chai
      .request(server)
      .put("/comment/66791a552b38d88d8c6e9ee7")
      .auth(valid_token, { type: "bearer" })
      .send({ contentText: "Nouveau text" })
      .end((err, res) => {
        res.should.have.status(404);
...
describe("DELETE - /comment", () => {
  ...
  it("Supprimer un commentaire incorrect (avec un id inexistant). - E", (done) => {
    chai
      .request(server)
      .delete("/comment/665f18739d3e172be5daf092")
      .auth(valid_token, { type: "bearer" })
      .end((err, res) => {
        res.should.have.status(404);
        done();
...
describe("DELETE - /comments", () => {
  it("Supprimer plusieurs commentaires incorrects (avec un id inexistant). - E", (done) => {
    chai
      .request(server)
      .delete("/comments/665f18739d3e172be5daf092&665f18739d3e172be5daf093")
      .auth(valid_token, { type: "bearer" })
      .end((err, res) => {
        res.should.have.status(404);
        done();
