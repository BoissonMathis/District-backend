...
describe("addOneEvent", () => {
    ...
    it("Evenement incorrect. (sans contentText) - E", () => {
        ...
        EventService.addOneEvent(event_without_textContent, null, function (err, value) {
            expect(value).to.be.a('object');
            expect(value).to.haveOwnProperty('msg')
            expect(value).to.haveOwnProperty('fields_with_error')
            expect(value).to.haveOwnProperty('fields')
...
describe("findOneEvent", () => {
    ...
    it("Chercher un evenement par un champ non autorisé. - E", (done) => {
        EventService.findOneEvent(["test"], events[0].contentText, null, function (err, value) {
            expect(err).to.be.a('object')
            expect(err).to.haveOwnProperty('msg')
    ...
    it("Chercher un evenement sans champ de recherche. - E", (done) => {
        EventService.findOneEvent([], events[0].contentText, null, function (err, value) {
            expect(err).to.be.a('object')
            expect(err).to.haveOwnProperty('msg')
...
describe("findManyEvents", () => {
    ...
    it("Faire une recherche sur le contentText avec une query vide - S", (done) => {
        EventService.findManyEvents(null, 'contentText', 3, 1, null, function (err, value) {
            expect(value).to.haveOwnProperty("count")
            expect(value).to.haveOwnProperty("results")
    ...
    it("Faire une recherche sur le contentText avec une query qui ne correspond a aucun evenement - S", (done) => {
        EventService.findManyEvents('awtbrieoqpmfnhgsekl', 'contentText', 3, 1, null, function (err, value) {
            expect(value).to.haveOwnProperty("count")
            expect(value).to.haveOwnProperty("results")
